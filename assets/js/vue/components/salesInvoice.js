            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="col-xs-12" v-if="installments.length > 0" >
                                <div style="border: 1px solid #bbb;padding: 5px;">
                                    <table>
                                        <tr>
                                            <td>
                                                <strong>Month: {{ sales.installment_month }}</strong>
                                            </td>                                
                                            <td>
                                                <strong>Install Tk.: {{ sales.installment_amount }}</strong>
                                            </td>
                                        </tr>
                                        <tr>                                
                                            <td colspan="2" style="font-weight:bold;border-bottom: 1px solid #ccc;">Payment Detes:</td>
                                        <tr>                                
                                            <td colspan="2"> <span v-for="data in installments">{{ data.installment_date }} | </span></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>

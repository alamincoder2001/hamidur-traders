...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (
			...
			|| array_search("monthlyPaymentReport", $access) > -1
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php if (array_search("monthlyPaymentReport", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>monthlyPaymentReport">
								<i class="menu-icon fa fa-caret-right"></i>
...
<?php } elseif ($module == 'AccountsModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("installment_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>installment_report">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Installment Report </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

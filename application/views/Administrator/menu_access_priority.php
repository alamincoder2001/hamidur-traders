        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="monthlyPaymentReport" v-model="access"> Monthly Payment Report</li>
                    ...
                    <li><input type="checkbox" class="access" value="installment_report" v-model="access"> Installment Report</li>

				...
				<div class="widget-main">
					...
					<div class="row">
							...
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-xs-9">
										<div class="row">
											<div class="col-xs-5">
												<input type="text" class="form-control" placeholder="Model" v-model="selectedProduct.model" readonly />
											</div>
											<div class="col-xs-2 no-padding text-right">
												<label class="control-label"> Color </label>
											</div>
											<div class="col-xs-5">
												<input type="text" class="form-control" placeholder="Color" v-model="selectedProduct.color" readonly />
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-sm-2">
							...
							<div style="margin-top: 18px;color:blueviolet">
								<input id="installment" type="checkbox" v-model="installment">
								<label class="installment" for="installment">Is Installment</label>
							</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:13%;color:#000;">Product Code</th>
									...
									<tr style="display: none;" :style="{display: sales.isInstallment == true ? '' : 'none'}">
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" class="form-control" v-model="sales.installmentMonth" v-on:input="calculateTotal">
												</div>
											</div>
										</td>
									</tr>
									...
									<tr style="display: none;" :style="{display: sales.isInstallment == true ? '' : 'none'}">
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text" class="form-control" v-model="sales.installmentAmount" readonly>
												</div>
											</div>
										</td>
									</tr>
	...
	new Vue({
		...
		methods: {
			...
			calculateTotal() {
				...
				if (this.sales.isInstallment) {
					this.sales.installmentAmount = (parseFloat(this.sales.due) / parseInt(this.sales.installmentMonth)).toFixed(2)
				}
			},
			async saveSales() {
				if (this.selectedCustomer.Customer_SlNo == '') {
